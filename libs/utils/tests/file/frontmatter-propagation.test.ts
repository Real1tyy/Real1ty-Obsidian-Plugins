...
import type { NexusPropertiesSettings } from "../../src/file/frontmatter-propagation";
import {
...
describe("parseExcludedProps", () => {
	it("should parse user-excluded properties from comma-separated string", () => {
		const settings: NexusPropertiesSettings = {
			excludedPropagatedProps: "tags, category, status",
			parentProp: "parent",
	...
	it("should always exclude parent, children, related, and zettelId properties", () => {
		const settings: NexusPropertiesSettings = {
			excludedPropagatedProps: "",
			parentProp: "parent",
			childrenProp: "children",
			relatedProp: "related",
			zettelIdProp: "zettelId",
		...
		expect(excluded.has("children")).toBe(true);
		expect(excluded.has("related")).toBe(true);
		expect(excluded.has("zettelId")).toBe(true);
	});

	it("should handle custom property names for always-excluded properties", () => {
		const settings: NexusPropertiesSettings = {
			excludedPropagatedProps: "",
			parentProp: "customParent",
			childrenProp: "customChildren",
			relatedProp: "customRelated",
			zettelIdProp: "customZettelId",
		};

		const excluded = parseExcludedProps(settings);

		expect(excluded.has("customParent")).toBe(true);
		expect(excluded.has("customChildren")).toBe(true);
		expect(excluded.has("customRelated")).toBe(true);
		expect(excluded.has("customZettelId")).toBe(true);
	});

	it("should combine user-excluded and always-excluded properties", () => {
		const settings: NexusPropertiesSettings = {
			excludedPropagatedProps: "tags, category",
			parentProp: "parent",
			childrenProp: "children",
			relatedProp: "related",
			zettelIdProp: "zettelId",
	...
	it("should handle empty excludedPropagatedProps string", () => {
		const settings: NexusPropertiesSettings = {
			excludedPropagatedProps: "",
			parentProp: "parent",
			childrenProp: "children",
	...
	it("should handle undefined excludedPropagatedProps", () => {
		const settings: NexusPropertiesSettings = {
			excludedPropagatedProps: undefined,
			parentProp: "parent",
			childrenProp: "children",
			relatedProp: "related",
			zettelIdProp: "zettelId",
	...
	it("should trim whitespace from property names", () => {
		...
		expect(excluded.has("category")).toBe(true);
		expect(excluded.has("status")).toBe(true);
		expect(excluded.has("  tags  ")).toBe(false);
	});
	...
	it("should handle single property without commas", () => {
		const settings: NexusPropertiesSettings = {
			excludedPropagatedProps: "tags",
			parentProp: "parent",
			childrenProp: "children",
			relatedProp: "related",
			zettelIdProp: "zettelId",
	...
	it("should deduplicate properties", () => {
		const settings: NexusPropertiesSettings = {
			excludedPropagatedProps: "tags, tags, category, tags",
			parentProp: "parent",
			childrenProp: "children",
			relatedProp: "related",
			zettelIdProp: "zettelId",
	...
	it("should handle case-sensitive property names", () => {
		const settings: NexusPropertiesSettings = {
			excludedPropagatedProps: "Tags, TAGS, tags",
			parentProp: "parent",
			childrenProp: "children",
			relatedProp: "related",
			zettelIdProp: "zettelId",
