...
describe("SettingsUIBuilder", () => {
	...
	describe("auto", () => {
		it("should auto-detect boolean and create toggle", () => {
			uiBuilder.auto(container, {
				key: "enabled",
				name: "Enable Feature",
				desc: "Turn this feature on or off",
			});

			const toggle = container.querySelector(".checkbox-toggle");
			expect(toggle).toBeDefined();
		});

		it("should auto-detect number and create slider", () => {
			uiBuilder.auto(container, {
				key: "maxItems",
				name: "Max Items",
				desc: "Maximum number of items",
		...
		it("should auto-detect string and create text input", () => {
			uiBuilder.auto(container, {
				key: "username",
				name: "Username",
				desc: "Your username",
		...
		it("should auto-detect array and create text array", () => {
			uiBuilder.auto(container, {
				key: "tags",
				name: "Tags",
				desc: "List of tags",
